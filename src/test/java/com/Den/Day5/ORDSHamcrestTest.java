...
public class ORDSHamcrestTest extends HRTestBase {
    ...
    public void employeesTest(){
        ...
        //verify emails without checking order (provided emails in different order, just make sure it has same emails)
        //expected names
        ...
        .then()
                ...
                .body("items.email",containsInAnyOrder("VPATABAL","DAUSTIN","BERNST","AHUNOLD","DOLERNTZ"))//contains without order
